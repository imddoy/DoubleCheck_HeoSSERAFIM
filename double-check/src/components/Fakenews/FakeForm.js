...
function FakeForm() {
  ...
  return (
    <StyledForm onSubmit={postFake}>
      <Flabel>제목</Flabel>
      <Form placeholder="제목을 입력하세요." onChange={handleTitle}></Form>
      <Flabel>신고 대상</Flabel>
      <Form
      ...
      <BtnDiv>
        ...
        <Btn bg="#3A42BF" color="white" onClick={openPopup} type="button">
          작성
        </Btn>
      </BtnDiv>
        ...
        <Overlay>
          <Popup>
            <PopupInner>
              ...
              <div>
                <PoPBtn onClick={closePopup} color="black" bg="white">
                  취소
                </PoPBtn>
                <PoPBtn color="white" bg="#3A42BF" type="submit">
                  등록
                </PoPBtn>
              </div>
            </PopupInner>
